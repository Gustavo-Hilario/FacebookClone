...
class FriendsTest extends TestCase
{
    ...
    public function a_user_can_send_a_friend_request_only_once()
    {
        ...
        /* Friend request anotherUser twice */
    ...
    public function friend_request_can_be_accepted()
    {
        ...
        /* startOfSecond() help us to avoid problems with microseconds */
    ...
    public function a_user_id_and_status_is_required_for_friend_request_responses()
    {
        ...
        $responseString = json_decode($response->getContent(), true);
        /* dd($responseString) using assertStatus was given me error but here
        I can see that I am getting status of 422, but is inside a error array. maybe is it.*/
    ...
    /*IGNORE FRIENDSHIPS REQUEST TESTS*/
