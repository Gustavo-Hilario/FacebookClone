<template>
    <div class="bg-white h-12 flex items-center px-4 border-b border-gray-400 shadow-sm">
        ...
        <div class="w-1/3">
            <div class="flex">
                ...
                <div class="ml-2 relative">
                    ...
                    <input type="text" name="search" class="w-56 h-8 pl-8 rounded-full bg-gray-200 text-sm  focus:outline-none focus:shadow-outline" placeholder="Search Facebook">
                </div>
            </div>
        </div>
        ...
        <div class="w-1/3 flex justify-center items-center h-full">
            <router-link to="/" class="flex items-center h-full px-6 border-b-2 border-blue-500 border-white">
                <!--House SVG-->
            ...
            <router-link :to="/users/ + authUser.data.user_id" class="flex items-center h-full px-6 border-b-2 border-white">
