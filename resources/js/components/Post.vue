<template>
    <div class="bg-white rounded shadow w-2/3 mt-6 overflow-hidden">
        ...
        <div class="py-2 px-4 flex justify-between text-gray-700 text-sm">
            <div class="flex items-center">
            ...
            <div class="flex items-center">
                ...
                <p class="ml-1">{{ post.data.attributes.comments.comment_count }} comments</p>
            </div>
        </div>

        <!-- Like and Comment Button -->
        <div class="flex justify-between border-1 border-gray-400 m-4">
            <button class="flex w-full justify-center items-center py-2 rounded-lg text-sm focus:outline-none"
            ...
            <button class="flex w-full justify-center items-center py-2 rounded-lg text-sm text-gray-700 focus:outline-none"
        ...
        <div v-if="comments" class="border-t border-gray-400 p-4 pt-2">
            <div class="flex">
                <input v-model="commentBody" type="text" name="comments" class="w-full pl-4 h-8 bg-gray-400 rounded-lg focus:outline-none" placeholder="Write your comment">
            ...
            <div class="flex my-4 items-center" v-for="comment in post.data.attributes.comments.data">
                ...
                <div class="ml-4 flex-1">
                    ...
                    <div>
                        <p class="text-xs pl-2">{{ comment.data.attributes.commented_at }}</p>
                    </div>
                </div>
            </div>
        </div>
